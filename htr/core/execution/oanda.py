...
from htr.brokerage.BrokerHandler import BrokerOanda
...
# oanda = BrokerOanda()
# events = queue.Queue()
# oanda_exec = OandaExecutionHandler(events, oanda)
# buy_order = oanda_exec.create_order('EUR_USD','MKT-OPEN', 100, 'BUY')
# oanda_exec.execute_order(buy_order)
# close_order = oanda_exec.create_order('EUR_USD','MKT-CLOSE', 100, 'SELL')
# oanda_exec.execute_order(close_order)