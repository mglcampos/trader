...
class Classifier:
    ...
    def __init__(self, price_data, ticker):
        ...
        feature_gen = FeatureGenerator(ticker)
        self.X, self.Y = feature_gen.get_sample(price_data)

    def re_train(self, x_vec, y):
        pass
...
class FeatureGenerator():
    ...
    def get_sample(self, price_data):
        ...
        return self.generate_regimes(self.lag_data(self.price_data))
    ...
    def generate_regimes(self, X):
        ...
        return Regimes, np.sign(Regimes.FReturns)
